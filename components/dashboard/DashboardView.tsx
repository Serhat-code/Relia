      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Reveal index={1} className="h-full">
          <StatCard
            ...
            hint={`${invoiceCount(summary.openCount)}, dont ${formatCurrency(summary.notDueAmount)} à échoir`}
          />
        </Reveal>
          ...
          <Reveal index={5}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Montants en retard, en euros, selon le temps écoulé depuis l&apos;échéance.</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <AgingChart buckets={summary.aging} />
              </CardContent>
            </Card>
          </Reveal>
          <Reveal index={6}>
